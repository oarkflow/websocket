...
[![Go Reference](https://pkg.go.dev/badge/github.com/oarkflow/websocket.svg)](https://pkg.go.dev/github.com/oarkflow/websocket)
...
```sh
go get github.com/oarkflow/websocket
```
...
- [Zero dependencies](https://pkg.go.dev/github.com/oarkflow/websocket?tab=imports)
- JSON helpers in the [wsjson](https://pkg.go.dev/github.com/oarkflow/websocket/wsjson) subpackage
- Zero alloc reads and writes
- Concurrent writes
- [Close handshake](https://pkg.go.dev/github.com/oarkflow/websocket#Conn.Close)
- [net.Conn](https://pkg.go.dev/github.com/oarkflow/websocket#NetConn) wrapper
- [Ping pong](https://pkg.go.dev/github.com/oarkflow/websocket#Conn.Ping) API
- [RFC 7692](https://tools.ietf.org/html/rfc7692) permessage-deflate compression
- [CloseRead](https://pkg.go.dev/github.com/oarkflow/websocket#Conn.CloseRead) helper for write only connections
- Compile to [Wasm](https://pkg.go.dev/github.com/oarkflow/websocket#hdr-Wasm)
...
- No extra goroutine per connection to support cancellation with context.Context. This costs github.com/oarkflow/websocket 2 KB of memory per connection.
...
Advantages of github.com/oarkflow/websocket:

- Minimal and idiomatic API
  - Compare godoc of [github.com/oarkflow/websocket](https://pkg.go.dev/github.com/oarkflow/websocket) with [gorilla/websocket](https://pkg.go.dev/github.com/gorilla/websocket) side by side.
- [net.Conn](https://pkg.go.dev/github.com/oarkflow/websocket#NetConn) wrapper
...
- Idiomatic [ping pong](https://pkg.go.dev/github.com/oarkflow/websocket#Conn.Ping) API
  - Gorilla requires registering a pong callback before sending a Ping
- Can target Wasm ([gorilla/websocket#432](https://github.com/gorilla/websocket/issues/432))
- Transparent message buffer reuse with [wsjson](https://pkg.go.dev/github.com/oarkflow/websocket/wsjson) subpackage
...
- [CloseRead](https://pkg.go.dev/github.com/oarkflow/websocket#Conn.CloseRead) helper for write only connections ([gorilla/websocket#492](https://github.com/gorilla/websocket/issues/492))
...
The [net.Conn](https://pkg.go.dev/github.com/oarkflow/websocket#NetConn) can help in transitioning
to github.com/oarkflow/websocket.
...
When writing idiomatic Go, github.com/oarkflow/websocket will be faster and easier to use.
